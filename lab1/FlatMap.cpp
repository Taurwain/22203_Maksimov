...
FlatMap::FlatMap(const FlatMap& b) : map_size(b.map_size), map_capacity(b.map_capacity){
...
FlatMap::FlatMap(FlatMap&& b) noexcept : values(b.values), keys(b.keys),
                                    map_size(b.map_size), map_capacity(b.map_capacity) {
    b.keys = nullptr;
    b.values = nullptr;
